...
#pragma warning(disable : 4996) //disable printf warning
...
u32 LoadModel(App* app, const char* filename, vec3 position, vec3 scale)
{
    ...
    SetScaling(scObj.worldMatrix, scale.x, scale.y, scale.z);
